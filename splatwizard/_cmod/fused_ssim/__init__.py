...
try:
    from . import _fused_ssim_cuda
except ImportError:
    from ._backend import _C as _fused_ssim_cuda
...
class FusedSSIMMap(torch.autograd.Function):
    ...
    def forward(ctx, C1, C2, img1, img2, padding="same", train=True):
        ssim_map, dm_dmu1, dm_dsigma1_sq, dm_dsigma12 = _fused_ssim_cuda.fusedssim(C1, C2, img1, img2, train)
    ...
    def backward(ctx, opt_grad):
        ...
        grad = _fused_ssim_cuda.fusedssim_backward(C1, C2, img1, img2, dL_dmap, dm_dmu1, dm_dsigma1_sq, dm_dsigma12)
