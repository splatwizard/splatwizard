...
# except:
#     from torch.cuda.amp import custom_bwd as raw_custom_bwd
#     from torch.cuda.amp import custom_fwd as raw_custom_fwd
#
#
#     def custom_bwd(*args, device_type=None, **kwargs):
#         return raw_custom_bwd(*args, **kwargs)
#
#
#     def custom_fwd(*args, device_type=None, **kwargs):
#         return raw_custom_fwd(*args, **kwargs)
from splatwizard.polyfills import custom_fwd, custom_bwd

try:
    from . import _gridencoder as _backend
except ImportError:
    from ._backend import _C as _backend
