...
//    std::cerr << position;
    ...
    glm::vec3 position_vec(position_data[0], position_data[1], position_data[2]);
    auto rotation_mat = glm::mat3({{rotation_data[0], rotation_data[1], rotation_data[2]},
                                   {rotation_data[3], rotation_data[4], rotation_data[5]},
                                   {rotation_data[6], rotation_data[7], rotation_data[8]}});
//    std::cerr << position_vec[0] << ' ' << &position_vec;
//std::cerr << &rotation_mat << std::endl;
    preprocess(
        ...
        curr_offset.contiguous().data_ptr<int>());
//    std::cerr << curr_offset;
}
