...
def render_scene(model_path, test_performance=False):
    ...
    for camera_json in cameras_json:
        ...
        print("image name = %s" % camera.img_name, camera_json)
...
if __name__ == "__main__":
    if len(sys.argv) >= 2:
        ...
        models_path = "/data1/lizhuo/gaussian-splatting/bicycle_model/"  # https://repo-sam.inria.fr/fungraph/3d-gaussian-splatting/datasets/pretrained/models.zip
        render_scene(models_path, True)
