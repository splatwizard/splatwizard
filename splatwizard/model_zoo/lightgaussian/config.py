...
@dataclass
class LightGaussianParams(ModelParams):
    sh_degree: int = 3


@dataclass
class LightGaussianOptimizationParams(OptimizationParams):
...
@dataclass
class LightGaussianPruneOptimizationParams(LightGaussianOptimizationParams):
    require_pretrained = False
    position_lr_init = 0.0000016
    position_lr_final = 0.0000016
    position_lr_delay_mult = 0.01
...
@dataclass
class LightGaussianDistillOptimizationParams(LightGaussianOptimizationParams):
...
@dataclass
class LightGaussianEncodeOptimizationParams(LightGaussianOptimizationParams):
    new_max_sh_degree: int = 2
